...
| **MTG (Media Termination Gateway)** | External | Manages DFPWM audio transcoding and termination of SIP traffic. | Custom |
...
| **Radius** | A standard protocol for authentication, authorization, and accounting (AAA) used between the SIP Proxy, MTG and Radius Server. | UDP |
| **SIP (Session Initiation Protocol)** | A standard protocol for initiating, maintaining, and terminating real-time sessions used between the SIP Proxy and MTG. | TCP |
